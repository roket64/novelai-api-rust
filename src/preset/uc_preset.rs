...
#[deprecated = "NAI Diffusion V2 is no longer supported."]
...
#[deprecated = "NAI Diffusion V1 is no longer supported."]
...
#[deprecated = "NAI Diffusion Furry V1 is no longer supported."]
